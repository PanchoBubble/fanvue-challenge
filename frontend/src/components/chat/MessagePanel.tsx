      ...
      <div className="relative flex-1">
        ...
        {showScrollButton && (
          <button
            ...
            className="bg-surface-active hover:bg-surface-page border-border-subtle absolute right-4 bottom-4 flex h-10 w-10 cursor-pointer items-center justify-center rounded-full border shadow-lg transition-colors"
