...
export class AuthService {
  ...
  async register(username: string, password: string): Promise<{ user: Pick<User, "id" | "username">; token: string }> {
  ...
  async login(username: string, password: string): Promise<{ user: Pick<User, "id" | "username">; token: string }> {
